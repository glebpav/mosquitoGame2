...
public class GameSettings {
    ...
    public final static int HARD_COUNT_OF_BUTTERFLY = 15;
    public final static int MEDIUM_COUNT_OF_BUTTERFLY = 10;
    public final static int EASY_COUNT_OF_BUTTERFLY = 7;

    public final static int BUTTERFLY_DAMAGE = 50;

    public final static int HARD_COUNT_OF_HP = 100;
